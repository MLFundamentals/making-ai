...
MAX_EPOCHS: dict[str, int] = {
    # 첫 실측(2026-08-18, Actions): 3에포크 DNN 0.9644 / 2에포크 CNN 0.9828.
    # 러너가 예상보다 빨라(CNN 2에포크 29초) 여유가 많으므로 에포크를 올렸다.
    # 정확도를 책 값에 가깝게 끌어올려 임계값과의 간격을 벌리기 위한 것이다.
    "MNIST_DNN.ipynb": 6,      # 원본 10 · 3에포크 0.9644 → 6에포크로 상향
    "MNIST_CNN.ipynb": 4,      # 원본 10 · 2에포크 0.9828 → 4에포크로 상향
