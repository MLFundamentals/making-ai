...
CASES = [
    ...
    dict(chapter=4, section="IV-4", file="MNIST_DNN.ipynb",
         marker="모델 정확도", mode="measure", metric=ACC_PERCENT, printed=0.9747,
         note="에포크 상한 적용. 이번 실행값으로 임계값을 정한다"),
    dict(chapter=4, section="IV-5", file="MNIST_CNN.ipynb",
         marker="모델 정확도", mode="measure", metric=ACC_PERCENT, printed=0.9894,
         note="에포크 상한 적용. 이번 실행값으로 임계값을 정한다"),
    ...
    dict(chapter=5, section="V-3", file="Reinforcement Learning_Level 3-1.ipynb",
         marker="성공률", mode="measure", metric=SUCCESS_RATE, printed=0.3370,
         note="실측 범위 28.5~37.1%"),
    dict(chapter=5, section="V-3", file="Reinforcement Learning_Level 3-2.ipynb",
         marker="성공률", mode="measure", metric=SUCCESS_RATE, printed=0.6140,
         note="실측 범위 57.0~70.9%"),
